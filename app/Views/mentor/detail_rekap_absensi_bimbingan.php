...
<div class="container-fluid">
    <div class="mt-4 d-flex justify-content-start mb-4">
        <a href="<?php echo base_url('mentor/dashboard/rekap_absensi_bimbingan'); ?>" class="btn btn-secondary btn-sm">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($peserta as $absen): ?>
                            <tr>
                                ...
                                <td><a href="https://www.google.com/maps?q=<?= $absen->latitude_masuk; ?>,<?= $absen->longitude_masuk; ?>" target="_Blank">Periksa Lokasi Masuk</a></td>
                                <td><a href="https://www.google.com/maps?q=<?= $absen->latitude_keluar; ?>,<?= $absen->longitude_keluar; ?>" target="_Blank">Periksa Lokasi Keluar</a></td>
