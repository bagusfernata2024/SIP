    ...
    <div class="card shadow mb-4">
        ...
        <div class="py-3" style="margin-left: 10px; margin-right: 10px;">
            <div class="progress">
                ...
                <div class="progress-bar bg-success" role="progressbar" style="width: 34%;" aria-valuenow="100"
                    aria-valuemin="0" aria-valuemax="100">
        ...
        <div class="mt-4" style="margin-right: 20px;">
            <form method="post" action="<?php echo base_url('mentor/dashboard/terima_surat_perjanjian'); ?>">
