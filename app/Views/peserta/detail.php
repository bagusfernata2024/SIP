    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php } else { ?>
                ...
                <form method="post" action="<?php echo base_url('dashboard/update_status'); ?>">
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $detail['tgl_regis']; ?></td>
                        </tr>
                        <tr>
                            <th>Tanggal Mulai</th>
                            <td><?php echo $detail['tanggal1']; ?></td>
                        </tr>
                        <tr>
                            <th>Tanggal Selesai</th>
                            <td><?php echo $detail['tanggal2']; ?></td>
                        </tr>
                        <tr>
                            <th>Status</th>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('dashboard/file/' . $detail['surat_permohonan']); ?>"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('dashboard/file/' . $detail['proposal_magang']); ?>"
                                    class="btn btn-primary btn-sm" download>Download</a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('dashboard/file/' . $detail['cv']); ?>"
                                    class="btn btn-primary btn-sm" download>Download</a>
                            </td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Marksheet</td>
                            <td><?php echo $detail['marksheet']; ?></td>
                            <td>
                                <a href="<?php echo base_url('dashboard/file/' . $detail['marksheet']); ?>"
                                    class="btn btn-primary btn-sm" download>Download</a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('dashboard/file/' . $detail['fc_ktp']); ?>"
                                    class="btn btn-primary btn-sm" download>Download</a>
                            </td>
                        </tr>
                        ...
                        <div class="mt-3">
                            <a href="<?php echo base_url('dashboard/download_all/' . $detail['id_register']); ?>" class="btn btn-success btn-sm">Download Semua Lampiran</a>
                        </div>
                        <br>
                    </tbody>
                </table>
...
<script>
    ...
    document.getElementById('confirmAction').addEventListener('click', function() {
        ...
        if (actionType && nipgValue) {
            ...
            form.method = 'POST';
            form.action = '<?php echo base_url("dashboard/update_status"); ?>';
